...
namespace ZZ.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        private const string DataTablePath = "Assets/ZZRestaurant/DataTables";
        private const string CSharpCodePath = "Assets/ZZRestaurant/Scripts/DataTable";
        private const string CSharpCodeTemplateFileName = "Assets/ZZRestaurant/Configs/DataTableCodeTemplate.txt";
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "ZZ");
